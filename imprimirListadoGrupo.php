...
echo '<table align="center" cellspacing="1" width="100%" rules="rows" bgcolor="#F2F2F2" cellpadding="4" id="tabla">';
...
while($row=pg_fetch_array($grupo,NULL,PGSQL_ASSOC)){
	...
	echo '<tr>';
		...
		if ($row['foto_alumno'] != ''){
			echo '<td align="center" cellpadding="0"><img src='.$row['foto_alumno'].' width="50" height="50"></td>';
		}else{
			echo '<td align="center" cellpadding="0"><img src="faltaFoto2.png" width="50" height="50"></td>';
		}
