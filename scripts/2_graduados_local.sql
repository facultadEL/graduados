...
CREATE TABLE alumno (
    ...
    ancho_final character varying (5),
    alto_final character varying (5),
    fechanacimiento_alumno character varying (10),
    calle_alumno character varying (40),
    ...
    twitter_alumno character varying (20),
    provincia_nac_alumno integer references provincia(id) NOT NULL,
    localidad_nac_alumno integer references localidad(id) NOT NULL,
    provincia_trabajo_alumno integer references provincia(id) NOT NULL,
    localidad_trabajo_alumno integer references localidad(id) NOT NULL,
    provincia_viviendo_alumno integer references provincia(id) NOT NULL,
    localidad_viviendo_alumno integer references localidad(id) NOT NULL,
